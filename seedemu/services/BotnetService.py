...
class BotnetServer(Server):
    ...
    def install(self, node: Node):
        ...
        node.addBuildCommand('git clone http://github.com/malwaredllc/byob.git /tmp/byob/')
...
class BotnetClientServer(Server):
    ...
    def install(self, node: Node):
        ...
        node.addSoftware('python3 git cmake python3-dev gcc g++ make python3-pip') 
        node.addBuildCommand('git clone http://github.com/malwaredllc/byob.git /tmp/byob/')
        node.addBuildCommand('mv /tmp/byob/byob/requirements.txt /tmp/byob-requirements.txt')
        # node.addBuildCommand('curl https://github.com/malwaredllc/byob/blob/master/byob/requirements.txt > /tmp/byob-requirements.txt')
